...
namespace Oilan
{
    public class OakQuest : Quest
    {
        ...
        public PlayableAsset oakTimeline_letterOpen;
        public PlayableAsset oakTimeline_letterClose;
        ...
        private IEnumerator OpenLetterCoroutine()
        {
            ...
            director.Play(oakTimeline_letterOpen);
        ...
        {
            director.Play(oakTimeline_letterClose);
