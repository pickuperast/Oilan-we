...
namespace UnityStandardAssets.Cameras
{
    ...
    public class AutoCam : PivotBasedCameraRig
    {
        ...
        [SerializeField] private bool freezeY = true; // freeze Y position
        ...
        protected override void FollowTarget(float deltaTime)
        {
            ...
            if (freezeY)
            {
                ...
                Vector3 tempTarget = new Vector3(m_Target.position.x, transform.position.y, m_Target.position.z);
                
                // camera position moves towards target position:
                //transform.position = Vector3.Lerp(transform.position, tempTarget, deltaTime * m_MoveSpeed);
                cameraRigRigidbody.MovePosition(Vector3.Lerp(transform.position, tempTarget, deltaTime * m_MoveSpeed));
            ...
            else
            {
                ...
                cameraRigRigidbody.MovePosition(Vector3.Lerp(transform.position, m_Target.position, deltaTime * m_MoveSpeed));
