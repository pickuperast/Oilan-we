...
namespace TextureMaker
{
    ...
    public enum PatternType { CHECKER, CIRCLES, TILE, TEST };
    ...
    public class PatternModule : ITextureModule
    {
        ...
        [SerializeField] private float turnFraction = 0.01f;
        ...
        public void Draw()
        {
            ...
            {
                turnFraction = EditorGUILayout.FloatField("Turn fraction", turnFraction);
            }
        ...
        public Texture2D GetTexture(Vector2Int textureSize)
        {
            switch(patternType)
            {
                ...
                case PatternType.TEST:
                    return TextureMaker.FillPattern(textureSize.x, textureSize.y, count, color1, color2, turnFraction, flipTexture);
                default:
                    return Texture2D.whiteTexture;
            }
        }
